...
message("=== 13b: Cell 1x2 sync — all config variants ===")
run_sync_variants(
  template_path = here::here("report", "shell", "template-cell-2x1.docx"),
  base_out_dir = here::here("scripts", "13b_cell_1x2_sync", "output"),
  figures_path = figures_path,
  tables_path = tables_path,
  standard_footnotes = standard_footnotes,
  config_path = config
)
message("13b complete")
